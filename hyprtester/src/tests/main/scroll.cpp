...
static void testScrollingViewBehaviourWorkspaceChange() {
    ...
    */
    ...
    // change to workspace 2, then back to "scroll" workspace again
    OK(getFromSocket("/dispatch workspace 2"));
    OK(getFromSocket("/dispatch workspace scroll"));
...
static void testScrollingViewBehaviourSpecialToSpecialWorkspaceChange() {
    ...
    */
    ...
    OK(getFromSocket("/dispatch togglespecialworkspace scroll_F 2"));
    OK(getFromSocket("/dispatch togglespecialworkspace scroll_S"));
    ...
    // test fail
        ...
        NLog::log("{}Failed: {}window of class 'a' does not have negative x coordinates for its position: {}", Colors::RED, Colors::RESET, currentWindowPosSPECIALX);
        ++TESTS_FAILED;
        ret = 1;
        return;
    }
...
static void testScrollingViewBehaviourCloseWindowInGroup() {
    ...
    */
    ...
    OK(getFromSocket("/dispatch killwindow class:b"));
    Tests::waitUntilWindowsN(2);
...
static void testScrollingViewBehaviourMoveWindowInGroupFollowFocusFalse() {
    ...
    */
    ...
    // test fail
        ...
        NLog::log("{}Failed: {}window of class 'b' does not have negative x coordinates for its position: {}", Colors::RED, Colors::RESET, currentWindowPosX);
        ++TESTS_FAILED;
        ret = 1;
        return;
    }
...
static void testScrollingViewBehaviourMoveWindowInGroupFollowFocusTrue() {
    ...
    */
    ...
    if (std::stoi(currentWindowPosX) < 0) {
        ...
        NLog::log("{}window of class 'b' does not have x coordinates >= 0 for its position: {}", Colors::RED, currentWindowPosX);
        ++TESTS_FAILED;
        ret = 1;
        return;
...
static void testScrollingViewBehaviourNewLayer() {
    ...
    */
    ...
    if (!Tests::spawnLayerKitty("myLayer")) {
        NLog::log("{}Error: {} layer did not spawn", Colors::RED, "myLayer");
        ++TESTS_FAILED;
        ret = 1;
        return;
    }
...
static void testScrollingViewBehaviourMaximise() {
    ...
    */
    ...
    // fullscreen class:b window
    OK(getFromSocket("/dispatch fullscreen 0"));

    // unfullscreen class:b window
    OK(getFromSocket("/dispatch fullscreen 0"));
...
static void testScrollingViewBehaviourFullscreen() {
    ...
    */
    ...
    // maximise class:b window
    OK(getFromSocket("/dispatch fullscreen 0"));

    // unmaximise class:b window
    OK(getFromSocket("/dispatch fullscreen 0"));
...
static void testScrollingViewBehaviourMoveFocusInGroupFollowFocusFalse() {
    ...
    */
    ...
    OK(getFromSocket("/keyword binds:movefocus_cycles_groupfirst true"));
    OK(getFromSocket("/keyword group:auto_group false"));
    OK(getFromSocket("/keyword scrolling:follow_focus 0"));
    ...
    // to revert the changes made to config
    NLog::log("{}Restoring config state", Colors::YELLOW);
    OK(getFromSocket("/keyword binds:movefocus_cycles_groupfirst false"));
    OK(getFromSocket("/keyword group:auto_group true"));
    OK(getFromSocket("/keyword scrolling:follow_focus 1"));
...
static void testScrollingViewBehaviourMoveFocusInGroupFollowFocusTrue() {
...
static bool test() {
    ...
    testScrollingViewBehaviourMoveFocusInGroupFollowFocusFalse();
    ...
    testScrollingViewBehaviourMoveFocusInGroupFollowFocusTrue();
